/*
	Xplorer plugin dll interface for 3ds max
...
extern ClassDesc2* GetColorVarDesc();
extern ClassDesc2* GetColorMaskDesc();
...
{
	switch(i) {
		case 0: return GetColorVarDesc();
		case 1: return GetColorMaskDesc();
		default: return 0;
	}
}
